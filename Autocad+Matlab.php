<?php 
$pageTitle="AutoCAD & MATLAB Online Course| Rinex ";
$pageDescription="AutoCAD & MATLAB technical certification courses for students and professionals."; 
include "header.php"; ?>
  ...
  <div class="container py-8">
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center py-7">
        <h1 data-aos="fade-up">AutoCAD & MATLAB <img src="assets/images/Verified-logo-rinex-website.png" style="height:20px;" alt="verified logo Rinex"></h1>
        <p data-aos="fade-up" data-aos-delay="400">2D/ 3D model rendering are designed to deliver the final outcomes of the machinery/ construction project using AutoCAD and for which MATRIX LABORATORY (MATLAB), the programming language is used to tune iterative analysis and design processes.
        </p>
        <div data-aos="fade-up" data-aos-delay="600">
        <!-- <h5 style="color:#09f557;">Verified by Professionals from:</h5>
        <img src="assets/images/partner/Brigade-RInex-2.png" height="100px" width="135px" class="patnerim" alt="Brigade-RInex logo ">
        <img src="assets/images/partner/Autodesk-logo.png" height="60px" width="180px" class="patnerim1" style="padding-top:10px;" alt="Autodesk Rinex logo"> -->
        </div>
    ...
    <a href="#pricing" class="btn-get-started ">
      ...
      <div class="col-lg-6 hero-img py-8" data-aos="zoom-out" data-aos-delay="200">
        <img src="assets/images/Matlab-programspng.png" class="img-fluid" alt="" width="500px" height="300px" style="padding-top:50px;" alt="Autocad Rinex image">
      </div>
    </div>
  </div>
  ...
  <div class="container subsect bg-white mt-30 ">
    ...
    <div class="col-md-11 mt-30">
     ...
     <h6 class="subtitle">Verified Professionals from</h6>
      ...
      <!-- <div class="row mt-0"> -->
        <!-- <br/> -->
     <img src="assets/images/partner/Brigade-RInex-2.png" height="30px" width="100px" class="patnerim ml-30">
        <img src="assets/images/partner/Autodesk-logo.png" height="30px" width="100px"  class="patnerim1">
      <!-- </div>  -->
      </div>  
      </div>
      <div class="col-lg-4 col-md-6 subpoints mb-30">
      ...
      <div class="row gx-0">
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
          <div class="content">
            ...
            <h2>
              <center>Overview of </center>
              <center>AutoCAD & MATLAB</center>
            </h2>
            <p>
            AutoCAD is the popularly used computer drafting and designing software used in the Architectural and Construction Industry. It can create computer aided deigns of 2D & 3D for blue-printing building structure, computer chips and others. MATLAB is a matrix-based programming platform to analyze and design systems & products for your enterprise.
            </p>
        ...
        <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/images/pgr5.png" class="img-fluid" alt="programming logo image">
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="count-box">
            ...
            <div>
              <span>
                <p>2 Month</p>
              </span><!-- data-purecounter-start="0" data-purecounter-end="3 Months" data-purecounter-duration="1" class="purecounter"></span> -->
              <p>Durations</p>
            </div>
          </div>
        </div>
  ...
  <section id="features" class="features">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <header class="section-header">
        ...
        <p>Concepts Covered in AutoCAD & MATLAB </p>
      </header>

      <div class="row">

        <div class="col-lg-6">
          <img src="assets/images/features.png" class="img-fluid" alt="Concepts png image Rinex">
        </div>
        ...
        <div class="col-lg-6 mt-5 mt-lg-0 d-flex">
          <div class="row align-self-center gy-4">
            ...
            <div class="col-md-6" data-aos="zoom-out" data-aos-delay="800">
              <div class="feature-box d-flex align-items-center">
                <i class="bi bi-check"></i>
                <h3>Toolbox for Mechanical Engineers</h3>
              </div>
            </div>
            <div class="col-md-6" data-aos="zoom-out" data-aos-delay="900">
              <div class="feature-box d-flex align-items-center">
                <i class="bi bi-check"></i>
                <h3>Mechanism Problem-solving & Calculations</h3>
              </div>
            </div>
...
<div class="container" data-aos="fade-up">
  ...
  <header class="section-header">
    ...
    <p>Projects under AutoCAD & MATLAB</p>
  </header>
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div class="service-box blue">
                ...
                <h3>Design better Civil Infrastructure</h3>
                <p>Civil 3D software application is used to deliver computational designs for civil infrastructure projects. The design and documentation solutions are set to support Building Information Modeling (BIM) workflow on all the different projects of bridges, buildings, roads and highways, rail, airport and even construction in water levels.</p>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div class="service-box orange">
                <img src="assets/images/project1.png" class="img1">
                <h3>Real-Time Face Detection with MATLAB</h3>
                <p>This project as we all know is very helpful in security, image enhancement and identification. Even though seems easy, even the slightest change in the lighting can cause alteration in detection capabilities of the system. So, with MATLAB and its facial recognition algorithms, this project gained popularity in this technology.</p>
                <!-- <a href="#rs-contact" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a> -->
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
              <div class="service-box green">
                <img src="assets/images/project1.png" class="img1">
                <h3>Simulate Artificial Neural Networks</h3>
                <p>If you are familiar with the fundamentals of Artificial Intelligence and Machine Learning, you will know Artificial Neural Networks. ANNs are machines that imitate all human behavior and actions and with MATLAB you can simulate them by creating data models and training them with it. </p>
                <!-- <a href="#rs-contact" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a> -->
              </div>
            </div>
              ...
              <!-- <div class="zoom"> -->
                <div class="carousel-inner certificate mx">
                  <!-- <div class="carousel-item active">
                    <img src="assets/images/certificates3.jpg" width="90%" height="60%" alt="Microsoft Association Sample Certificate from Rinex">
                  </div> -->
                  <div class="carousel-item active">
                    <img src="assets/images/Certificates/Autocad & Matlab/AutoCad-&-matlab-Rinex-Intership-Certificate-2021-Mahesh-Pokale.jpg" width="90%" height="60%" alt="AutoCAD& MATLAB, Rinex, Internship, Certificate, 2021">
                  </div>

                  <div class="carousel-item ">
              <img src="assets/images/Certificates/Autocad & Matlab/Completion-Certificate-2021-E-cell-IIT-Khagrapur-new-format-Mahesh.jpg" width="90%" height="60%" alt="AutoCAD & MATLAB, Completion, Certificate, 2021, E-Cell IIT Kharagpur, RineX">
              </div>
                </div>
              <!-- </div> -->
